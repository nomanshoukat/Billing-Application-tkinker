...
class Front:
    def __init__(self, window):
        ...
        text = self.right.create_text(400, 540, fill="#EEF5DB", font=(
            "cinzel", 27, "bold"), text="WELCOME TO Veggie RESTAURANT")
...
class Restra(Front):
    def __init__(self, root):
        ...
        self.top.place(x=0, y=0)
        # ===================Main label=============
        self.l1 = Label(self.top, text="Veggie RESTAURANT", font=self.font1,
        ...
        self.L1 = Label(
            self.bill,
            text="PORJECT MEMBER:-PULKIT SAINI & ROHIT KUMAR BHARTI",
            font=(
                "cooper",
                17,
                "italic"),
        ...
        self.ric.insert(
            END, str("      DESCRIPTION       QTY   RATE    AMOUNT"))
    ...
    def vgadd(self):
        ...
        if str2 == "":
            result = tkMessageBox.showwarning(
                'WARNING', 'Please Enter The Dish Qut.', icon="warning")
        else:
    ...
    def nvgadd(self):
        ...
        if str2 == "":
            result = tkMessageBox.showwarning(
                'WARNING', 'Please Enter the Quantity', icon="warning")
        else:
    ...
    def insert(self):
        ...
        if str1 == "":
            result = tkMessageBox.showwarning(
                'WARNING', 'Please Enter the Customer Name', icon="warning")
        elif set('1234567890').intersection(str1):
            result = tkMessageBox.showwarning(
                'WARNING', 'Customer Name Cannot be in Number', icon="warning")
        elif set('!@#$%^&*)(_+=-}{][|/;,.><:').intersection(str1):
            result = tkMessageBox.showwarning(
                'WARNING', 'Customer Name Cannot be in charater', icon="warning")

        elif str3 == "":
            result = tkMessageBox.showwarning(
                'WARNING', 'Please Calculate the bill', icon="warning")
        else:
            str10 = str(str10)
            self.entry2.delete('0', END)
            self.entry2.insert(END, str(str10))
            self.ric.insert(END, str("\t     Veggie RESTAURANT"))
            self.ric.insert(END, str("\n\tGSTIN/UIN:05AAACS8577K1ZV "))
            self.ric.insert(END, str("\n\tState Name: Punjab Code:5"))
            self.ric.insert(END, str("\n\tE-Mail:noman.shoukat66@gmail.com"))
            self.ric.insert(END, str("\n\t\tPOS INVOICE"))
            self.ric.insert(
                END, str(
            ...
            with myconn1:
                ...
                cursor1.execute(
                    "INSERT INTO COMPANY(ID,NAME,BILL) VALUES(?,?,?)", (str10, str1, text))
            myconn1.commit()
...
class Menu:
    def __init__(self, root):
        ...
        self.lb1 = Label(
            self.veg,
            text="SHAHI PANEER\t\t 250      KADAI PANEER\t 320",
            font=self.font4,
            bg="#4F6367",
            fg="#EEF5DB",
            justify=RIGHT)
        ...
        self.lb2 = Label(
            self.veg,
            text="PANEER KEEMA\t\t 220      MALIA KOFTA\t 180",
            font=self.font4,
            bg="#4F6367",
            fg="#EEF5DB",
            justify=RIGHT)
        ...
        self.lb1 = Label(
            self.ngveg,
            text="CHICKEN ACHAARI\t 250      MUTTON TANGRI\t 320",
            font=self.font4,
            bg="#4F6367",
            fg="#EEF5DB",
            justify=RIGHT)
        ...
        self.lb1 = Label(
            self.swee,
            text="GULAB JAMUN\t\t 10      RASMALAYI\t\t 25",
            font=self.font4,
            bg="#4F6367",
            fg="#EEF5DB",
            justify=RIGHT)
        ...
        self.lb2 = Label(
            self.swee,
            text="MOONG KI DAL KA HALWA\t 20       ICE CREAM\t\t 40",
            font=self.font4,
            bg="#4F6367",
            fg="#EEF5DB",
            justify=RIGHT)
        ...
        self.lb3 = Label(
            self.drink,
            text="LEMON SODA\t\t 15      BUTTER SKOTCH SHAKE 40",
            font=self.font4,
            bg="#4F6367",
            fg="#EEF5DB",
            justify=RIGHT)
...
class Bill:
    ...
    def fun(self):
        if self.entry.get() == "":
            result = tkMessageBox.showwarning(
                'WARNING', 'Please enter the bill number', icon="warning")
        else:
            self.ric.delete('1.0', END)
            ...
            with conn:
                cursor = conn.cursor()
                cursor.execute(
                    'SELECT BILL FROM COMPANY WHERE ID=?', [
                        self.entry.get()])
    ...
    def exp(self):
        result = tkMessageBox.askquestion(
            '', 'Are you sure you want to export this record?', icon="warning")
        if result == 'yes':
            conn = sqlite3.connect("restra.db")
            cursor = conn.cursor()
...
class About:
    def __init__(self, window):
        ...
        self.l1 = Label(
            self.right,
            text="first for the customers and the other for the management side. The ",
            font=(
                "cinzel",
                18,
                "bold"),
...
window.title("Veggie RESTAURANT")
window.geometry("1366x768")
window.mainloop()
